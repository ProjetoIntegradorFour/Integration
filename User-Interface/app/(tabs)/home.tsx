...
export default function App() {
  ...
  useEffect(() => {
    if (books.length > 0) {
      prefetchCovers(books.slice(0, 20));
    }
  }, [books]);
        ...
        <AuthorCarousel
          ...
          authors={[
            ...
            },
            {
              ...
              image: "https://s5.static.brasilescola.uol.com.br/be/2022/08/machado-assis.jpg",
            },
            {
              id: "4",
              name: "Carolina Maria de Jesus",
              image: "https://s2.static.brasilescola.uol.com.br/be/2020/03/escritora-c.jpg",
            },
            {
              id: "5",
              name: "Cecília Meireles",
              image: "https://static.todamateria.com.br/upload/mi/23/mi2325797636722939d-0.jpg",
            },
            {
              id: "6",
            ...
            },
            {
              id: "7",
              name: "Jorge Amado",
              image: "https://static.todamateria.com.br/upload/57/44/57449a7fe6be7-jorge-amado.jpg",
            },
          ]}
        />
